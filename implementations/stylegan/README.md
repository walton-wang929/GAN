...
1. You should prepare lmdb dataset：
...
## pre-trained model
 ...
 [trained using FFHQ, 140k iter, 256px](https://drive.google.com/file/d/1SFn7GygaLYhOobNQH_eqICcQETDcBC0X/view)
